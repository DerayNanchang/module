package com.lsn.lib_image_picker.activity.multi;
...
import com.lsn.lib_image_picker.activity.preview.MultiImagePreviewActivity;
...
import com.lsn.lib_image_picker.bean.SelectMode;
import com.lsn.lib_image_picker.bean.selectconfig.BaseSelectConfig;
import com.lsn.lib_image_picker.bean.selectconfig.MultiSelectConfig;
import com.lsn.lib_image_picker.data.IReloadExecutor;
...
public class MultiImagePickerFragment extends PBaseLoaderFragment implements View.OnClickListener,
    ...
    private boolean isIntentDataValid() {
        ...
        if (bundle != null) {
            selectConfig = (MultiSelectConfig) bundle.getSerializable(MultiImagePickerActivity.INTENT_KEY_SELECT_CONFIG);
            presenter = (IPickerPresenter) bundle.getSerializable(MultiImagePickerActivity.INTENT_KEY_PRESENTER);
            if (presenter == null) {
