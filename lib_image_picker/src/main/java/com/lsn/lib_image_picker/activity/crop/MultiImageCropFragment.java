package com.lsn.lib_image_picker.activity.crop;
...
import com.lsn.lib_image_picker.activity.PBaseLoaderFragment;
import com.lsn.lib_image_picker.adapter.PickerFolderAdapter;
import com.lsn.lib_image_picker.adapter.PickerItemAdapter;
import com.lsn.lib_image_picker.bean.ImageCropMode;
...
import com.lsn.lib_image_picker.bean.PickerItemDisableCode;
import com.lsn.lib_image_picker.bean.selectconfig.BaseSelectConfig;
import com.lsn.lib_image_picker.bean.selectconfig.CropSelectConfig;
import com.lsn.lib_image_picker.data.OnImagePickCompleteListener;
import com.lsn.lib_image_picker.helper.CropViewContainerHelper;
import com.lsn.lib_image_picker.helper.PickerErrorExecutor;
import com.lsn.lib_image_picker.helper.RecyclerViewTouchHelper;
import com.lsn.lib_image_picker.helper.VideoViewContainerHelper;
import com.lsn.lib_image_picker.presenter.IPickerPresenter;
import com.lsn.lib_image_picker.utils.PCornerUtils;
import com.lsn.lib_image_picker.utils.PViewSizeUtils;
import com.lsn.lib_image_picker.views.PickerUiConfig;
import com.lsn.lib_image_picker.widget.TouchRecyclerView;
...
public class MultiImageCropFragment extends PBaseLoaderFragment implements View.OnClickListener,
    ...
    private boolean isIntentDataValid() {
        ...
        if (null != arguments) {
            presenter = (IPickerPresenter) arguments.getSerializable(MultiImageCropActivity.INTENT_KEY_DATA_PRESENTER);
            selectConfig = (CropSelectConfig) arguments.getSerializable(MultiImageCropActivity.INTENT_KEY_SELECT_CONFIG);
        }
